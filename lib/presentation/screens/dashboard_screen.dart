...
class DashboardScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return SingleChildScrollView(child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: <Widget>[
      PageHeader(title: 'Willkommen bei My Fridge 👋', subtitle: 'Behalte deinen Vorrat im Blick und verschwende weniger.', action: FilledButton.icon(onPressed: () => showAddFoodDialog(context, state), icon: const Icon(Icons.add), label: const Text('Lebensmittel'))),
